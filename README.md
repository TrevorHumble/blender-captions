...
1. Grab [`dist/captions_tool-0.1.2.zip`](dist/captions_tool-0.1.2.zip) from this
...
```powershell
Compress-Archive -Force -Path .\captions_tool -DestinationPath .\dist\captions_tool-0.1.2.zip
```
